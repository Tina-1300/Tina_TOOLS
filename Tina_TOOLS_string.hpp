...
public:
    ...
    */
     ...
     *     Tina_TOOLS_string tina_str;
     *     std::string p = "txt";
     *     if(tina_str.Tina_is_palindrome(p, Tina_return_bool) == Tina_TRUE){
     *         std::cout << "Le mot : " << p << " est bien un palindrom" << std::endl;
     *     }else if(tina_str.Tina_is_palindrome(p, Tina_return_bool) == Tina_TRUE){
     *         std::cout << "le mot : " << p << " n'est pas un palindrom" << std::endl;
     *     }else{
     ...
     * ```
    */
    static std::string Tina_is_palindrome(std::string strr){
        std::string p = strr;
        std::string l = Tina_reverseString(p);
        if(l == p){
            return l; 
        }else{
            return "is note palindrome";
        }
    }
